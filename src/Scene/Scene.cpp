...
void rt::Scene::createObjects(void)
{
    _objects.push_back(std::make_shared<rt::Sphere>(maths::Vector3f(-350.f, -50.f, -400.f), 
                        150, Material(sf::Color::Blue, 0.5f, 0.5f, 80.0f, 0.45f), DEFAULT_STONE_TEXTURE_PATH));
    ...
    _objects.push_back(std::make_shared<rt::Plane>(maths::Vector3f(0.f, 1.f, 0.f),
                        maths::Vector3f(0.f, -200.f, 0.f), Material(sf::Color::Yellow, 1.0f, 0.5f, 150.0f), DEFAULT_CHECKERBOARD_TEXTURE_PATH));
